...
type Heap[T any] struct {
	...
	data []T
	// comp compares two values and returns true if a is smaller than b
...
// swap swaps the values at indeces i and j
...
// Pop returns the top value of the heap and rearrange the heap
...
// assumes that the binary trees rooted at LEFT.i/ and RIGHT.i/ are max- heaps, but that AŒi􏰌
// might be smaller than its children, thus violating the max-heap property
